...
LOAD_BEC_TRAINSET = 'load_bec_trainset_path'  # second train stream: BEC-labeled frames
LOAD_BEC_VALIDSET = 'load_bec_validset_path'  # BEC validation, batched at bec_batch_size
LOAD_BECSET = 'load_becset_path'  # legacy alias of LOAD_BEC_TRAINSET
BEC_BATCH_SIZE = 'bec_batch_size'
STRATIFIED_LOSS_RESCALE = 'stratified_loss_rescale'
